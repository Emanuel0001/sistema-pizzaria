    ...
    <div className="container-app">
      ...
      <div className='menu-lateral'>
        <div className='container-menu-lateral'>
          ...
          <Link to='/hamburger' className='link-hamburger'><FaHamburger id='icons-hamburger' size={40} /></Link>
      ...
      <div className='container'>
        <div className='container-blocos'>
          <div className='bloco'>
            <div className='bloco-title'> <h3>hamburger</h3></div>
            <div className='bloco-body-container'><img src={hamburger}></img></div>
            <div className='bloco-descricao'><p>Pão, Hamburguer, Alface, Tomate, Batata e palha</p></div>
          ...
          <div className='bloco'>
            <div className='bloco-title'> <h3>X BURGUER</h3></div>
            <div className='bloco-body-container'><img src={Xburger}></img></div>
            <div className='bloco-descricao'><p>Pão, Hamburguer, Alface, Queijo, tomate e Batata palha</p></div>
            <div className='bloco-add'>
              <h3>$ 43,25</h3>
              <IoMdAddCircle class="icone-add" onClick={openModalAddItem} size={50} color="yellow" />
            </div>
        ...
        <div className='container-blocos'>
          <div className='bloco'>
            <div className='bloco-title'> <h3>MISTO</h3></div>
            <div className='bloco-body-container'><img src={Misto}></img></div>
            <div className='bloco-descricao'><p>Pão de forma, Presunto e 02 queijos</p></div>
            <div className='bloco-add'>
              <h3>$ 43,25</h3>
              <IoMdAddCircle class="icone-add" onClick={openModalAddItem} size={50} color="yellow" />
            </div>
          ...
          <div className='bloco'>
            <div className='bloco-title'> <h3>X bacon</h3></div>
            <div className='bloco-body-container'><img src={Xbacon}></img></div>
            <div className='bloco-descricao'><p>Pão, Hamburguer, Queijo, Alface, Tomate e Batata palha</p></div>
            <div className='bloco-add'>
              <h3>$ 43,25</h3>
              <IoMdAddCircle class="icone-add" onClick={openModalAddItem} size={50} color="yellow" />
            </div>
